...
/*Enter temperature; 
30
If you have a windspeed velocity measuring 4, with a temperature of 30 degrees, then using the old style windchill formula gives a windchill factor of 29.7189
Entering those same numbers of windspeed and temperature into the new style windchill formula, gives you a windchill factor of 25.767, which then, gives you a difference of 3.95188.
...
Enter temperature; 
39.25
If you have a windspeed velocity measuring 10, with a temperature of 39.25 degrees, then using the old style windchill formula gives a windchill factor of 29.7189
Entering those same numbers of windspeed and temperature into the new style windchill formula, gives you a windchill factor of 25.767, which then, gives you a difference of 3.95188.
...
Enter temperature; 
100
If you have a windspeed velocity measuring 2, with a temperature of 100 degrees, then using the old style windchill formula gives a windchill factor of 29.7189
Entering those same numbers of windspeed and temperature into the new style windchill formula, gives you a windchill factor of 25.767, which then, gives you a difference of 3.95188.
